...
static void keypad_read(lv_indev_drv_t * indev_drv_key, lv_indev_data_t * data);
...
//    lv_indev_set_cursor(indev_mouse, mouse_cursor);
    ...
    indev_drv_key.read_cb = keypad_read;
    indev_keypad = lv_indev_drv_register(&indev_drv_key);
